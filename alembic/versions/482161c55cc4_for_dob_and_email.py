...
Revision ID: 482161c55cc4
Revises: 
Create Date: 2022-09-19 16:14:57.120593
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'general_info', 'register', ['user_name'], ['user_name'], ondelete='CASCADE')
    op.alter_column('log', 'username',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.add_column('register', sa.Column('mailid', sa.String(), nullable=True))
    op.add_column('register', sa.Column('dob', sa.Date(), nullable=True))
    op.create_unique_constraint(None, 'register', ['mailid'])
    op.drop_column('register', 'father_name')
    op.drop_column('register', 'mother_name')
...
def downgrade() -> None:
    ...
    op.alter_column('token', 'id',
               ...
               nullable=True,
               autoincrement=True)
    op.add_column('register', sa.Column('mother_name', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('register', sa.Column('father_name', sa.VARCHAR(), autoincrement=False, nullable=False))
