"""change to null false

Revision ID: 88c905b636a7
Revises: 8c26ba7ac5a6
Create Date: 2022-09-01 16:09:10.574797
...
revision = '88c905b636a7'
down_revision = '8c26ba7ac5a6'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('register', 'age',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('register', 'gender',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('register', 'father_name',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('register', 'mother_name',
               existing_type=sa.VARCHAR(),
               nullable=False)
