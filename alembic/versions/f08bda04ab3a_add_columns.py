...
Revision ID: f08bda04ab3a
Revises: 5f1226cf15a1
Create Date: 2022-09-01 12:47:20.535306
...
revision = 'f08bda04ab3a'
down_revision = '5f1226cf15a1'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    # op.drop_table('post')
    op.add_column('general_info', sa.Column('sclpro_school', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('year_begin', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('year_end', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('workday_21_22', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('workday_20_21', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('workday_19_20', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('hours_21_22', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('hours_20_21', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('hours_19_20', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('instructional_hours_21_22', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('instructional_hours_20_21', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('instructional_hours_19_20', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('non_instructional_hours_21_22', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('non_instructional_hours_20_21', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('non_instructional_hours_19_20', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('holidays_21_22', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('holidays_20_21', sa.Integer(), nullable=True))
    op.add_column('general_info', sa.Column('holidays_19_20', sa.Integer(), nullable=True))
    # op.add_column('general_info', sa.Column('sclpro_school', sa.INTEGER(), nullable=True))
    # op.drop_column('general_info', 'sclpro_school')
...
def downgrade() -> None:
    ...
    op.alter_column('log', 'username',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.add_column('general_info', sa.Column('sclpro_school', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_column('general_info', 'holidays_19_20')
    op.drop_column('general_info', 'holidays_20_21')
    op.drop_column('general_info', 'holidays_21_22')
    op.drop_column('general_info', 'non_instructional_hours_19_20')
    op.drop_column('general_info', 'non_instructional_hours_20_21')
    op.drop_column('general_info', 'non_instructional_hours_21_22')
    op.drop_column('general_info', 'instructional_hours_19_20')
    op.drop_column('general_info', 'instructional_hours_20_21')
    op.drop_column('general_info', 'instructional_hours_21_22')
    op.drop_column('general_info', 'hours_19_20')
    op.drop_column('general_info', 'hours_20_21')
    op.drop_column('general_info', 'hours_21_22')
    op.drop_column('general_info', 'workday_19_20')
    op.drop_column('general_info', 'workday_20_21')
    op.drop_column('general_info', 'workday_21_22')
    op.drop_column('general_info', 'year_end')
    op.drop_column('general_info', 'year_begin')
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='post_user_id_fkey', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='Votes_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('post_id', name='Votes_pkey')
    )
    ...
    sa.Column('phone_no', sa.INTEGER(), autoincrement=False, nullable=True),
